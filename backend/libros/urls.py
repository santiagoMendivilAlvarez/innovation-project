...
urlpatterns = [
    ...
    path('libros/buscar/',        views.book_search_view,    name='book_search'),  # Specific route FIRST
    ...
    path('libros/<str:book_id>/', views.book_detail_view,    name='book_detail'),  # Dynamic route LAST
]
